...
def test_fixture_loading():
    ...
    print(f"   [PASS] Loaded {len(sales):,} total sales records")
    ...
    print(f"   [PASS] Found {len(flexguard):,} FlexGuard records")
    ...
    print(f"   [PASS] Loaded {len(rates):,} rate records")
    ...
    print(f"   [PASS] Loaded {len(weights):,} weight records")
    ...
    print(f"   [PASS] Loaded {len(macro):,} macro records")
